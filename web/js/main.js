$(document).ready(function() {
    ...
    $('.prospective-students-content').hide();
    $('#prospective-visit').show();

    $('.ps-content-toggle').click(function(e) {
        e.preventDefault();

        var selected = $(this).attr('href').replace(/^.*?(#|$)/,'');
        $('.prospective-students-content').hide();
        $('#prospective-' + selected).show();
    ...
    $('div').children('.slideshow--slider').each(function() {
        var $slideshow_slider = $(this); //$('.slideshow--slider');
        ...
        $slideshow_slider.cycle({
            ...
            'fx': 'scrollHorz',
            'log': false,
            'overlay': '> .slideshow--overlay .slideshow--overlay__wrapper',
            ...
            'pager': '> .slideshow--slider__pager .slideshow--slider__pager__wrapper',
